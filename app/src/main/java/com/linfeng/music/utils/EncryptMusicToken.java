...
public class EncryptMusicToken {
    private static final String first = "ylzsxkwm";
    ...
    public static String encrypt(String content) {
        ...
        byte[] a = a(bytes, bytes.length, first.getBytes());
        return new String(EncryptMusicHandler.a(a, a.length));
    }
